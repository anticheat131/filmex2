...
import { getOnTheAirTVShows } from '@/utils/services/tv';
...
export default function TVOnTheAir() {
  ...
  // TMDB's /tv/on_the_air returns 500 pages max
        ...
        <div className="max-w-7xl mx-auto px-4 py-8 w-full flex-1">
          <div className="mb-6">
            ...
            <p className="max-w-3xl text-muted-foreground text-left">
              {t('Explore TV shows that are currently on the air. Stay up to date with the latest episodes and never miss a moment of your favorite series!')}
            </p>
          </div>
          <div>
            {loading ? (
