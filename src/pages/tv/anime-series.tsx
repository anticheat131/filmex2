      ...
      <main className="flex flex-col min-h-screen pt-20">
        <div className="max-w-7xl mx-auto px-4 py-8 w-full flex-1">
          <div className="md:mb-12 md:mt-6 text-left">
            <h1 className="mb-2 text-2xl font-medium text-white text-left">Anime TV Shows</h1>
            <p className="max-w-3xl text-muted-foreground text-left">
              Dive into the vast world of anime series, from ongoing hits to all-time classics. Find your next binge-worthy show across all genres and art styles.
            </p>
          </div>
            ...
            <Sheet open={filterOpen} onOpenChange={setFilterOpen}>
              ...
              <SheetContent side="right" className="fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 inset-y-0 right-0 h-full w-3/4 border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-sm flex flex-col px-0">
                <div className="flex flex-col space-y-2 text-center sm:text-left px-4 md:px-6">
                  ...
                  <p className="text-sm text-muted-foreground">Narrow down your anime search results.</p>
                </div>
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="grid gap-2 md:grid-cols-2">
                      <div className="space-y-2">
                        <label className="text-sm font-medium leading-none text-muted-foreground">From</label>
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-medium leading-none text-muted-foreground">To</label>
                    ...
                    {/* Language */}
                    <div className="space-y-2">
                      <label className="text-sm font-medium leading-none text-muted-foreground">Language</label>
                    ...
                    <div className="space-y-4">
                      <label className="text-sm font-medium leading-none text-muted-foreground">Vote Average</label>
                    ...
                    {/* Minimum Votes */}
                    <div className="space-y-4">
                      <label className="text-sm font-medium leading-none text-muted-foreground">Minimum Votes</label>
          ...
          <div>
            {loading ? (
              <div className="text-white text-center py-12">Loading anime TV shows...</div>
            ) : (
          ...
          <div className="flex justify-center mt-10">
            <button className="px-3 py-2 mx-1 rounded bg-gray-800 text-white disabled:opacity-50" onClick={() => setPage(page - 1)} disabled={page === 1}>Previous</button>
            <span className="px-4 py-2 text-white">Page {page} of {totalPages}</span>
            <button className="px-3 py-2 mx-1 rounded bg-gray-800 text-white disabled:opacity-50" onClick={() => setPage(page + 1)} disabled={page === totalPages}>Next</button>
          </div>
        </div>
        <Footer />
      </main>
