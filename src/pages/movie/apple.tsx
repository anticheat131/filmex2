...
export default function MovieApple() {
  ...
  useEffect(() => {
    ...
    getDiscoverMovies(params)
      ...
      .catch(() => setError('Failed to load Apple TV+ movies.'))
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 px-4 pt-20 pb-8 max-w-7xl mx-auto w-full">
        <header className="mb-6 mt-2 flex flex-col items-start">
          ...
          <p className="max-w-3xl text-muted-foreground text-left">Discover Apple TV+'s lineup of critically acclaimed series, compelling dramas, and groundbreaking documentaries. Enjoy a selection curated with quality and innovation in mind.</p>
        </header>
