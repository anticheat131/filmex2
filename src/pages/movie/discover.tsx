				...
				<div className="main-container mx-auto px-4 py-8 w-full flex-1" style={{maxWidth:'1850px'}}>
					<div className="text-left">
						...
						<p className="text-gray-300 mt-1 text-base max-w-2xl text-left">
							{t('Find movies by genre, rating, year, and more. Use the filters and sorting options to explore TMDB’s vast movie collection.')}
						</p>
					</div>
					<div className="flex flex-row justify-end gap-2 mt-10 mb-2">
