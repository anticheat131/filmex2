        ...
        <div aria-labelledby="movies-dropdown-trigger" data-orientation="horizontal" className="left-0 top-0 w-full md:absolute md:w-auto" style={{textAlign: 'left'}}>
          ...
          <div className="grid w-[650px] grid-cols-2 p-4" style={{textAlign: 'left'}}>
            <Link className="select-none space-y-2 rounded-md p-3 hover:bg-accent bg-[#43437b] hover:bg-[#333385]" to="/movie/discover">
              ...
              <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">{t('MoviesDropdownDiscoverDescription')}</p>
            </Link>
            <Link className="select-none space-y-2 rounded-md p-3 hover:bg-accent" to="/movie/popular">
              <div className="text-sm font-medium leading-none">
                <div className="flex items-center">
              ...
              <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">{t('MoviesDropdownPopularDescription')}</p>
            </Link>
            <Link className="select-none space-y-2 rounded-md p-3 hover:bg-accent" to="/movie/now-playing">
              <div className="text-sm font-medium leading-none">
                <div className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-play mr-2 inline size-3"><polygon points="6 3 20 12 6 21 6 3"></polygon></svg> {t('Now Playing')}
                </div>
              </div>
              <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">{t('MoviesDropdownNowPlayingDescription')}</p>
            </Link>
            <Link className="select-none space-y-2 rounded-md p-3 hover:bg-accent" to="/movie/upcoming">
              <div className="text-sm font-medium leading-none">
                <div className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-calendar mr-2 inline size-3"><path d="M8 2v4"></path><path d="M16 2v4"></path><rect width="18" height="18" x="3" y="4" rx="2"></rect><path d="M3 10h18"></path></svg> {t('Upcoming')}
                </div>
              </div>
              <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">{t('MoviesDropdownUpcomingDescription')}</p>
            </Link>
            <Link className="select-none space-y-2 rounded-md p-3 hover:bg-accent" to="/movie/top-rated">
              <div className="text-sm font-medium leading-none">
                <div className="flex items-center">
