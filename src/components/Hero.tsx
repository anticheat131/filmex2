...
const Hero = ({ media: initialMedia, className = '' }: HeroProps) => {
  ...
  return (
    <>
      <section
        className={`h-hero relative w-full aspect-[1.88/1] min-h-[425px] max-h-[860px] md:aspect-[2/1] md:min-h-[420px] md:max-h-[700px] bg-black rounded-md shadow-2xl border border-white/10 flex items-center justify-center overflow-hidden -mt-[4vh] md:mt-0 ${className}`}
      ...
      >
        ...
        <button className="absolute right-2 top-2 z-10 rounded-full p-2 text-white bg-black/40 hover:bg-black/70" title={t('Add to Favorites')}>
        ...
        <div className="overlay absolute inset-0 flex items-end justify-center z-20">
          <div className="mx-auto main-container space-y-4 p-4 pb-8 text-center md:p-14 max-w-[95vw] w-[95vw] md:max-w-full md:w-full">
